...
public class LocalRoundTrip {
  ...
  public void roundtripTest() throws Exception {
    ...
    CompletableFuture<PlaintextDocument> roundtrip = TestUtils
        .createTscWithAllowInsecure(tsp_address + tsp_port, api_key).thenCompose(client -> {
  ...
  public void logSecurityEventBadTenant() throws Exception {
    ...
    CompletableFuture<Void> logEvent = TestUtils
        .createTscWithAllowInsecure(tsp_address + tsp_port, api_key).thenCompose(client -> {
