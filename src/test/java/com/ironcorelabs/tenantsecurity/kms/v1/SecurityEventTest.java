...
public class SecurityEventTest {
  public void interfaceConsistencyCheck() throws Exception {
    ...
    // PERIODIC
    assertEquals(
        PeriodicEvent.ENFORCE_RETENTION_POLICY.getFlatEvent(), "PERIODIC_ENFORCE_RETENTION_POLICY");
    ...
    assertEquals(
        UserEvent.REQUEST_EMAIL_VERIFICATION.getFlatEvent(), "USER_REQUEST_EMAIL_VERIFICATION");
