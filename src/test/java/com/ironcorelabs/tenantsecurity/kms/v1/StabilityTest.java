...
@Test(groups = { "dev-stability" })
public class StabilityTest {
    private String GCP_TENANT_ID = "murph-tenant";
    private String AZURE_TENANT_ID = "ernie-azure-tenant";
    private String API_KEY = "iiuvQsYkThgB2t/o";
    ...
    private void roundtripTest(String tenantId) throws Exception {
        Map<String, String> customFields = new HashMap<>();
        customFields.put("org_name", "Cisco");
        customFields.put("attachment_name", "thongsong.mp3");
        DocumentMetadata context = new DocumentMetadata(tenantId, "integrationTest", "sample", customFields, "customRayID");
    ...
    public void test() throws Exception {
        roundtripTest(GCP_TENANT_ID);
        roundtripTest(AZURE_TENANT_ID);    
    }
}
