...
public class ErrorResponseTest {
    ...
    public void exceptionFromErrorResponseTspServiceException() throws Exception {
        ...
        ErrorResponse invalidRequestBody = new ErrorResponse(
                TenantSecurityErrorCodes.INVALID_REQUEST_BODY.getCode(), staticMsg);
        ...
        ErrorResponse invalidEdekErrResp = new ErrorResponse(
                TenantSecurityErrorCodes.INVALID_PROVIDED_EDEK.getCode(), staticMsg);
        ...
        TenantSecurityException unwrapException =
                unwrapError.toTenantSecurityException(staticHttpCode);
        ...
        TenantSecurityException kmsWrapException =
                wrapError.toTenantSecurityException(staticHttpCode);
        assertKmsException(staticMsg, staticHttpCode, kmsWrapException,
                TenantSecurityErrorCodes.KMS_WRAP_FAILED);

        ErrorResponse kmsAuthError = new ErrorResponse(
                TenantSecurityErrorCodes.KMS_AUTHORIZATION_FAILED.getCode(), staticMsg);
