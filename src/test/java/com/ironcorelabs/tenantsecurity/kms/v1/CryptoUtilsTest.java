...
public class CryptoUtilsTest {
  ...
  public void generateHeaderShouldProduceKnownResult() throws Exception {
    ...
    byte[] expectedHeaderProtoBytes = {10, 28, 49, 113, -17, 60, -119, -97, -121, 94, 89, 92, 34,
        19, -54, -49, -110, -121, -57, -116, -15, -106, 69, -116, -42, -112, 84, 73, -128, -57, 26,
        10, 10, 8, 116, 101, 110, 97, 110, 116, 73, 100};
  ...
  public void verifyV3DocWithZeroSize() throws Exception {
    byte[] edoc = new byte[] {3, 73, 82, 79, 78, 0, 0, 52, 97, 69, -17, -65, 32, 85, -70, 101, 109,
        -67, 31, -28, -38, -19, -78, 42, 125, 124, -47, 80, 31, 10, 127, -109, -20, 90, 7, 88, 104,
        103, -64, -56, 38, 95, 96, -97, -92, -54};
  ...
  public void streamingEncryptWithNormalDecryptLargeDocument() throws Exception {
    ...
    if (timeTaken > cutoffMillis) {
      throw new Exception("Decrypting " + plaintext.length + " took " + timeTaken
