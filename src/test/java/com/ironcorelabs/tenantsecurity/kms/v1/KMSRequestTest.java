...
public class KMSRequestTest {
  ...
  public void errorCodeWhenEdekFormatIsWrong() throws Exception {
    ...
    CompletableFuture<PlaintextDocument> decrypt =
        TenantSecurityClient.create(
  ...
  public void exceptionFromErrorResponseTspServiceException() throws Exception {
    ...
    assertTspServiceException(
        staticMsg, staticHttpCode, unknownErrException, TenantSecurityErrorCodes.UNKNOWN_ERROR);
    ...
    // KmsException
    ErrorResponse noPrimaryKmsResp =
        new ErrorResponse(
    ...
    assertKmsException(
        staticMsg,
        staticHttpCode,
        noPrimaryKmsException,
        TenantSecurityErrorCodes.NO_PRIMARY_KMS_CONFIGURATION);

    ErrorResponse unknownTenantError =
        new ErrorResponse(
    ...
    assertKmsException(
        staticMsg, staticHttpCode, unwrapException, TenantSecurityErrorCodes.KMS_UNWRAP_FAILED);
    ...
    assertKmsException(
        staticMsg, staticHttpCode, kmsWrapException, TenantSecurityErrorCodes.KMS_WRAP_FAILED);
    ...
    assertSecurityEventException(
        staticMsg,
        staticHttpCode,
        securityEventRejectedException,
        TenantSecurityErrorCodes.SECURITY_EVENT_REJECTED);
  }

  private void assertTspServiceException(
      String expectedMsg,
      int expectedHttpStatusCode,
      TenantSecurityException exception,
  ...
  private void assertSecurityEventException(
      String expectedMsg,
      int expectedHttpStatusCode,
      TenantSecurityException exception,
      TenantSecurityErrorCodes errorCode) {
  ...
  private void assertKmsException(
      String expectedMsg,
      int expectedHttpStatusCode,
      TenantSecurityException exception,
      TenantSecurityErrorCodes errorCode) {
  ...
  private void assertTenantSecurityException(
      String expectedMsg,
      int expectedHttpStatusCode,
      TenantSecurityException exception,
      TenantSecurityErrorCodes errorCode) {
