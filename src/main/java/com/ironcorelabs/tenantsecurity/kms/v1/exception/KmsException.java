...
public class KmsException extends TenantSecurityException {
   ...
   *        error.
   */
  public KmsException(TenantSecurityErrorCodes errorCode, int httpResponseCode,
      String errorMessage) {
   ...
   * @param cause The Throwable that caused this one.
   */
  public KmsException(TenantSecurityErrorCodes errorCode, int httpResponseCode, Throwable cause) {
   ...
   * @param cause The Throwable that caused this one.
   */
  public KmsException(TenantSecurityErrorCodes errorCode, Throwable cause) {
   ...
   * @param errorCode TSP generated code corresponding with this error.
   */
  public KmsException(TenantSecurityErrorCodes errorCode) {
    this(errorCode, 0);
  }
}
