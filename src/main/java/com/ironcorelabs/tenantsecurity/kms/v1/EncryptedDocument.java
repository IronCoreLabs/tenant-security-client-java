...
/**
 * Holds result of encrypting a document with the Tenant Security KMS client. Contains the
 * document's fields in encrypted form and the encrypted key (EDEK) that was used to encrypt those
 * fields.
 */
