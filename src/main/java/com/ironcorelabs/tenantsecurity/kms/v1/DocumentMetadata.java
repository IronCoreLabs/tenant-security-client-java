 ...
 * is accessing the data, it's classification, as well as optional fields for
 * other arbitrary key/value pairs and a request ID to send to the Tenant Security Proxy.
 */
public class DocumentMetadata {
    ...
    /**
     * Constructor for DocumentMetadata class which contains arbitrary key/value
     * pairs and a unique request ID to send to the Tenant Security Proxy.
     *
     * @param tenantId                  Unique ID of tenant that is performing the
     *                                  operation.
     ...
     *                                  metadata.
     * @param requestId                 Unique ID that ties host application request
     *                                  ID to Tenant Security Proxy logs.
    ...
    public DocumentMetadata(String tenantId, String requestingUserOrServiceId, String dataLabel,
            Map<String, String> otherData, String requestId) throws IllegalArgumentException {
    ...
    /**
     * Constructor for DocumentMetadata class which contains arbitrary key/value
     * pairs to send to the Tenant Security Proxy.
     *
     * @param tenantId                  Unique ID of tenant that is performing the
     *                                  operation.
     * @param requestingUserOrServiceId Unique ID of user/service that is processing
    ...
    public DocumentMetadata(String tenantId, String requestingUserOrServiceId, String dataLabel,
        ...
        this(tenantId, requestingUserOrServiceId, dataLabel, otherData, null);
    }

    /**
     * Constructor for DocumentMetadata class which contains a unique request ID to
     * send to the Tenant Security Proxy.
     *
     * @param tenantId                  Unique ID of tenant that is performing the
     *                                  operation.
     * @param requestingUserOrServiceId Unique ID of user/service that is processing
    ...
    public DocumentMetadata(String tenantId, String requestingUserOrServiceId, String dataLabel, String requestId) {
        this(tenantId, requestingUserOrServiceId, dataLabel, null, requestId);
    }
     ...
     */
    public DocumentMetadata(String tenantId, String requestingUserOrServiceId, String dataLabel) {
        this(tenantId, requestingUserOrServiceId, dataLabel, null, null);
    }
     ...
     * data to the Tenant Security Proxy. Adds all standard fields to the Map and then
