...
/**
 * A map from a document ID to a DEK and its encrypted form (EDEK) wrapped with
 * the tenants KMS, both in base64 format. Also includes a map of failures if
 * any problems occured when performing the batch wrap operation.
 */
