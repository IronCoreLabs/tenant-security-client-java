...
/**
 * A map from an EDEK ID to a DEK decrypted with the tenants KMS, both in base64 format. Also
 * includes a map of failures if any problems occured when performing the batch unwrap operation.
 */
